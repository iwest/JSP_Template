...
!function(Foundation, window){
   ...
   * @function
   * @param {jQuery} element - jQuery object to testee for collisions.
  ...
  if (!styleMedia) {
    ...
    styleMedia = {
      matchMedium: function(media) {
        var text = '@media ' + media + '{ #matchmediajs-testee { width: 1px; } }';
...
!function($, Foundation){
  ...
  Dropdown.defaults = {
    ...
    hOffset: 1,
    /**
     * Class applied to adjust open position. JS will testee and fill this in.
     * @option
     * @example 'top'
     */
    positionClass: '',
